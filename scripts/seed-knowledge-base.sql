-- =============================================================================
-- Seed: Knowledge Base (knowledge_items)
-- Cria a tabela e insere dados iniciais de cursos e links institucionais.
-- Pode ser executado diretamente no SQL Editor do Supabase Dashboard
-- ou via CLI: npx supabase db push (se colocado em supabase/migrations/)
-- =============================================================================
